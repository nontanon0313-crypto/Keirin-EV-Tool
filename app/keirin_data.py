...
JO_CODE_TO_VENUE = {
    # 北日本(未検証: 規則性からの推定のみ)
    "11": "函館", "12": "青森", "13": "いわき平",
    # 関東(検証済み: 弥彦=21, 西武園=26を実URLで確認)
    "21": "弥彦", "22": "前橋", "23": "取手", "24": "宇都宮",
    "25": "大宮", "26": "西武園", "27": "京王閣", "28": "立川",
    # 南関東(検証済み: 川崎=34, 静岡=38を実URLで確認)
    "32": "松戸", "33": "千葉", "34": "川崎", "35": "平塚",
    "36": "小田原", "37": "伊東温泉", "38": "静岡",
    # 中部(検証済み: 岐阜=43, 大垣=44, 豊橋=45, 富山=46を実URLで確認)
    "42": "名古屋", "43": "岐阜", "44": "大垣", "45": "豊橋",
    "46": "富山", "47": "松阪", "48": "四日市",
    # 近畿(検証済み: 奈良=53のみ、他は推定)
    "52": "福井", "53": "奈良", "54": "向日町", "55": "和歌山", "56": "岸和田",
    # 中国(検証済み: 玉野=61のみ、他は推定)
    "61": "玉野", "62": "広島", "63": "防府",
    # 四国(検証済み: 高知=74のみ、他は推定)
    "72": "高松", "73": "小松島", "74": "高知", "75": "松山",
    # 九州(検証済み: 武雄=84, 佐世保=85を実URLで確認)
    "82": "小倉", "83": "久留米", "84": "武雄", "85": "佐世保", "86": "別府", "87": "熊本",
}

# 上記のうち、複数箇所の実URLで直接確認できたブロックのみ(自動インポートで無警告に使える)
JO_CODE_VERIFIED_BLOCKS = {
    "21", "22", "23", "24", "25", "26", "27", "28",  # 関東
    "32", "33", "34", "35", "36", "37", "38",  # 南関東
    "42", "43", "44", "45", "46", "47", "48",  # 中部
}
