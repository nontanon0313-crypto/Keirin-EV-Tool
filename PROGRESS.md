...
最終更新: 2026-09-06(Grok) — 投票タブ: 本日/30分キャッシュ、本命選択、0件でも候補見える化

### 投票タブ改善
1. 本日・直前30分を5分キャッシュ(画面切替で再取得しない)。🔄で強制更新
2. 「本日」選択で本命パネルを非表示(HTMLはキャッシュ)
3. 本命行タップでレース選択
4. 読み込み中表示で待ちを明示
5. プラン0件時も preview_candidates で落ちた候補を表示
